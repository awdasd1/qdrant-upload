...
- ✅ دعم البحث الهجين (Hybrid Search): الجمع بين متجهات BM25 Sparse والمتجهات الكثيفة Dense عبر RRF
- ✅ واجهة ويب تفاعلية للبحث عن المواد القانونية وإدارتها
- ✅ دعم التضمينات المحلية و API الخارجية (Cohere, OpenAI, Gemini, Jina)
